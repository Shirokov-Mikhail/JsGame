            ...
            <div class="container">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="book-form" action='add_book.php' method='post' content="multiply">
                            <div class="form-row">
                                <div class="form-group error">
                                    <label for="book-title">Название книги*</label>
                                    <input type="text" id="book-title" placeholder="Введите название книги" name='name'  <?php if(isset($err_name)){
                                        echo('style="border: 1px solid red"');
                                    } 
                                    else{
                                        echo('style="border: 1px solid #ddd"');
                                    }
                                        ?>>
                                    <?php if(isset($err_name)){
                                        echo('<span class="error-message" style="display: block;">Поле обязательно для заполнения (макс. 100 символов)</span>');
                                    }
                                    ?>
                                </div>
                                <div class="form-group">
                                    <label for="book-author">Автор*</label>
                                    <input type="text" id="book-author" placeholder="Введите автора" name='author' <?php if(isset($err_author)){
                                        echo('style="border: 1px solid red"');
                                    } 
                                    else{
                                        echo('style="border: 1px solid #ddd"');
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="book-genre" name='genre' <?php if(isset($err_genre)){
                                        echo('style="border: 1px solid red"');
                                    } 
                                    else{
                                        echo('style="border: 1px solid #ddd"');
                                    ...
                                    <?php if(isset($err_genre)){
                                        echo('<span class="error-message" style="display: block;">Пожалуйста, выберите жанр</span>');
                                    }
                                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="book-year" placeholder="Год издания" name='year_of_publication' <?php if(isset($err_year)){
                                        echo('style="border: 1px solid red"');
                                    } 
                                    else{
                                        echo('style="border: 1px solid #ddd"');
                                        ...
                                        <?php if(isset($err_year)){
                                        echo('<span class="error-message" style="display: block;">Введите корректный год (1800-текущий)</span>');
                                    }
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="book-description" rows="4" placeholder="Краткое описание книги (до 500 символов)" name='description' <?php if(isset($err_desc)){
                                        echo('style="border: 1px solid red"');
                                    } 
                                    else{
                                        echo('style="border: 1px solid #ddd"');
                                ...
                                <?php if(isset($err_desc)){
                                        echo('<span class="error-message" style="display: block;">Максимальная длина описания 500 символов</span>');
                                    }
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="cover-upload">
                                    ...
                                    <div class="upload-controls">
                                        ...
                                        <label class="btn btn-secondary error" ><i class="fas fa-upload"></i>
                                            <input type="file" id="cover" name='cover' value='cover'> Загрузить изображение
                                            <?php if(isset($err_file)){
                                        echo('<span class="error-message" style="display: block;">Поддерживаются только JPG изображения</span>');
                                    }
                                    ?>
                    ...
                    <form id="book-form">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span class="error-message" style="display: block;">Поле обязательно для заполнения (макс. 100 символов)</span>
                            </div>
                            <div class="form-group">
                                <label for="book-author">Автор*</label>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span class="error-message" style="display: block;">Пожалуйста, выберите жанр</span>
                            </div>
                            <div class="form-group">
                                <label for="book-year">Год издания*</label>
                                <input type="number" id="book-year" placeholder="Год издания">
                                <span class="error-message" style="display: block;">Введите корректный год (1800-текущий)</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="error-message" style="display: block;">Максимальная длина описания 500 символов</span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="error-message" style="display: block;">Поддерживаются только JPG изображения</span>
                        </div>
